...
const NewsSection = () => {
    const [newsData] = useState([
        {
            id: 1,
            title: "พิธีบำเพ็ญกุศลอุทิศถวาย - สวดมนต์ข้ามปี",
            description: "ขอเชิญร่วมพิธีบำเพ็ญกุศลอุทิศถวาย พระครูวิธานสุตโสภณ และพระครูสาครปิยธรรม พร้อมพิธีสวดมนต์ข้ามปี วันศุกร์ที่ 23 มกราคม 2568 ณ ศาลาการเปรียญฯ ผ.บางน้ำจืด อ.เมืองสมุทรสาคร จ.สมุทรสาคร (คลิกเพื่อดูรายละเอียดสวดมนต์ข้ามปี)",
